...
I'm **Ananthnath Erukulla**, a final-year B.Tech CSE student at **Lovely Professional University** and an aspiring **Data Analyst & Business Analyst** 🚀

---

### 👨‍💻 About Me
- 🎓 Final Year B.Tech (CSE), Graduating 2026
- 💡 Passionate about turning data into insights and crafting impactful visualizations
- 📊 Experienced in Python, Tableau, SQL, Excel, and ML model deployment
- 🧠 Built dashboards, analyzed business use cases, and delivered actionable insights
- 🤝 Currently seeking **Data/Business Analyst Internships**
...
### 📝 Recent Projects
- 📈 **E-commerce Analytics Dashboard** – Tableau + Excel
- 🔍 **Customer Segmentation using KMeans**
- 🤖 **Predictive Model for Student Performance**
- 🔄 **Automated EC2 Snapshot & Recovery with AWS Backup**
- 📊 **Sales Trend Visualization using Power BI**
